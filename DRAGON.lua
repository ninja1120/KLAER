...
sudo_users = {SUDO,1753323063,1236115319,1610557559,1800984632}   
...
if tonumber(user_id) == tonumber(1753323063) then  
var = true  
elseif tonumber(user_id) == tonumber(1610557559) then
var = true  
elseif tonumber(user_id) == tonumber(1236115319) then
var = true  
elseif tonumber(user_id) == tonumber(1800984632) then
var = true  
...
if tonumber(user_id) == tonumber(1800984632) then  
var = 'المبرمج صاصا '
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'بات مان'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "Source_kler")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼   ✯KLAER✯ ")  
...
send(msg.chat_id_, msg.id_,' ✯ تم تحديث السورس \n ✯ لديك اخر اصدار لسورس بات مان\n ✯ الاصدار » { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✯ اصدار سورس كلير\n ✯ الاصدار »{ v 1.5}')
end
if text == 'كلير مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV KLAER](t.me/M0STaFa_6)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '', url="t.me/M0STaFa_6"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/Source_kler"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝗧𝘄𝗮𝘀𝗼𝗹', url="t.me/BOODY22_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n ✯ العضو » ['..result.title_..'](t.me/'..(username or 'Source_kler')..')'
status  = '\n ✯ تم ترقيته مطور'
...
usertext = '\n ✯ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_kler')..')'
status  = '\n ✯ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✯ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Source_kler')..') \n ✯ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ✯ العضو : {["..data.first_name_.."](T.ME/Source_kler)}\n ✯ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✯ عذرا » {["..data.first_name_.."](T.ME/Source_kler)}\n ✯ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
✮ 𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗔𝗜𝗗𝗔  ✮
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿 SASA 🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️',url="t.me/M0STaFa_6"}},
{{text = '☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿 BOODY¹ 🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️',url="t.me/BoOdY_BaSha"}},
{{text = '☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿 BOODY² 🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️',url="t.me/BoOdY_BaSha"}},
{{text = '☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿 SOURSCE 🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️', url="t.me/Source_kler"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Source_kler&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مبرمج بودي' or text == 'يودي' or text == 'البابا' then
local Text = [[
[DEV BOODY](t.me/BoOdY_BaSha)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿 BOODY² 🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️',url="t.me/BoOdY_BaSha"}},
...
if text == 'بودي ابليس' or text == 'بودي' or text == 'بودي باشا' then
local Text = [[
[DEV BOODY](t.me/BoOdY_BaSha)
]]
keyboard = {} 
...
if text == 'صاصا' or text == 'مصطفي' or text == 'مبرمج' then
local Text = [[
DEV SASA
]]
keyboard = {} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝙨𝙤𝙪𝙧𝙘𝙚', url="t.me/Source_kler"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'مبرمج صاصا' then
local Text = [[ 
[DEV SASA](t.me/M0STaFa_6)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ✯KLAER✯ ', url="t.me/M0STaFa_6"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/M0STaFa_6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'العاب كلير' then
local Text = [[
𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙰𝙸𝙳𝙸
]]
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✯ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Source_kler')..') \n ✯ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✯ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Source_kler')..') \n ✯ تـم قفـل التاك بالكتم ')
end,nil)   
...
if result.sender_user_id_ == tonumber(1753323063) then
send(msg.chat_id_, msg.id_, " ✯ لا يمكنك حظر المبرمج بودي \n")
return false 
end
if result.sender_user_id_ == tonumber(1610557559) then
send(msg.chat_id_, msg.id_, " ✯ لا يمكنك حظر مبرمج صاصا\n")
return false 
end
if result.sender_user_id_ == tonumber(1800984632) then
send(msg.chat_id_, msg.id_, " ✯ لا يمكنك حظر المبرمج صاصا\n")
return false 
end
...
if tonumber(result.id_) == tonumber(1610557559) then  
send(msg.chat_id_, msg.id_, " ✯ لا تسطيع حظر مبرمج صاصا عام")
return false 
end
if tonumber(result.id_) == tonumber(1800984632) then  
send(msg.chat_id_, msg.id_, " ✯ لا تسطيع حظر المبرمج صاصا عام")
return false 
end
if tonumber(result.id_) == tonumber(1753323063) then  
send(msg.chat_id_, msg.id_, " ✯ لا تسطيع حظر المبرمج بودي  عام")
return false 
end
...
send(msg.chat_id_, msg.id_, " ✯ لا تسطيع حظر مبرمج صاصاعام")
return false 
end
if tonumber(userid) == tonumber(1800984632) then  
send(msg.chat_id_, msg.id_, " ✯ لا تسطيع حظر المبرمج صاصا عام")
return false 
end
...
if result.sender_user_id_ == tonumber(1753323063) then
send(msg.chat_id_, msg.id_, " ✯ لا يمكنك كتم المبرمج بودي\n")
return false 
end
if result.sender_user_id_ == tonumber(1610557559) then
send(msg.chat_id_, msg.id_, " ✯ لا يمكنك كتم المبرمج صاصا\n")
return false 
end
if result.sender_user_id_ == tonumber(1800984632) then
send(msg.chat_id_, msg.id_, " ✯ لا يمكنك كتم المبرمج صاصا\n")
...
if tonumber(result.id_) == tonumber(1753323063) then  
send(msg.chat_id_, msg.id_, " ✯ لا تسطيع كتم المبرمج بودي  عام")
return false 
end
if tonumber(result.id_) == tonumber(1610557559) then  
send(msg.chat_id_, msg.id_, " ✯ لا تسطيع كتم المبرمج صاصا عام")
return false 
end
if tonumber(result.id_) == tonumber(1800984632) then  
...
if Get_info then
local TextS = "\n ✯ اهلا بك في متجر ملفات بات مان\n ✯ ملفات السورس ↓\n≪━━━━━━  ✯KLAER✯ ━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━  ✯KLAER✯ ━━━━━━≫\n ✯ علامة تعني { ✔️ } ملف مفعل\n ✯ علامة تعني { ✖ } ملف معطل\n ✯ قناة سورس كلير↓\n".." ✯ [اضغط هنا لدخول](t.me/Source_kler) \n"
local NumFile = 0
...
if text == ("مسح قائمه بات مان") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ✯ تم مسح قائمه بات مان')
return false
end

if text == 'قائمه بات مان' and Sudo(msg) then
...
if #list == 0 then
t = " ✯ لا يوجد احد في قائمه بات مان"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع بات مان") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع كلير@(.*)$") and Sudo(msg) then
local username = text:match("^رفع كلير@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع كلير(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع كلير(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل بات مان") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل كلير@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل كلير@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل كلير(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل كلير(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✯ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_kler')..')'
status  = '\n ✯ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✯ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✯ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_kler')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✯ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Source_kler')..')'..'\n ✯ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'كلير').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'كلير')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
database:set(bot_id.."Source_kler:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."Source_kler:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Source_kler:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Source_kler:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✯تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."Source_kler:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Source_kler:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس كليريعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'بات مان').." غادر" or text == 'غادر' then  
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'بات مان')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_kler')..')'
local iduser = result.sender_user_id_
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙰𝙸𝙳𝙸', url="t.me/Source_kler"},
{text = 'مبرمج السورس', url="t.me/M0STaFa_6"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'≪━━━━━━  ✯KLAER✯ ━━━━━━≫ٴ\n✯ [   ✯KLAER✯  ](t.me/Source_kler)')
end
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 ??𝙴𝚂𝙰', url="t.me/Source_kler"},
{text = 'مبرمج السورس', url="t.me/M0STaFa_6"},
},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'بات مان')
